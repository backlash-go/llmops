...
func (s *apiServer) initOauthConfig() {
	if s.oauthOptions == nil {
		return
	}

	userv1.OAuthConfig = userv1.OAuthLoginConfig{
		AuthorizationEndpoint: s.oauthOptions.AuthorizationEndpoint,
		ClientID:              s.oauthOptions.ClientID,
		ClientSecret:          s.oauthOptions.ClientSecret,
		RedirectURI:           s.oauthOptions.RedirectURI,
		Scopes:                s.oauthOptions.Scopes,
		StateTTL:              s.oauthOptions.StateTTL,
		CookieSecure:          s.oauthOptions.CookieSecure,
	}
}
