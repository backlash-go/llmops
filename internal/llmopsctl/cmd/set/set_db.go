...
var setExample = templates.Examples(`
		...
		llmopsctl set db --mysql.host=127.0.0.1:3306 --mysql.username=iam --mysql.password=iamxxxx --mysql.database=iam

		# Create new iam platform database and tables with a administrator inserted
		llmopsctl set db --admin --mysql.host=127.0.0.1:3306 --mysql.username=iam --mysql.password=iamxxxx --mysql.database=iam

		# drop and create iam platform database and tables
		llmopsctl set db -d --mysql.host=127.0.0.1:3306 --mysql.username=iam --mysql.password=iamxxxx --mysql.database=iam`)
